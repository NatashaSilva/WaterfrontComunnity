...
const User = () => {
    ...
    useEffect(() => {
        // TODO
        axios.get(`${API_URL_ROOT}/${API_USERS_PATH}`)
            .then((response) => {
                    ...
                    <div key={user.name} className='user-card__info'>
                        ...
                        <div className='user-card__info--option'>
                            <div className='user-card__info--skills'>
                                <button to="/skills" className="user-card__info--button" onClick={handleSkillsClick}>
                                    Skills
                                </button>
                                <ul className={ showSkills ? "user-card__info--list" : "user-card__info--hidden"}>
                            ...
                            <div className='user-card__info--interest'>
                                <button to="/interest" className="user-card__info--button" onClick={handleInterestClick}>
                                    Interest
                                </button>
                                <ul className={ showInterest ? "user-card__info--list" : "user-card__info--hidden"}>
